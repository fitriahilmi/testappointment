...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_UsernameS'), 'John Doe')

WebUI.setEncryptedText(findTestObject('Page_CURA Healthcare Service/input_PasswordS'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')

WebUI.click(findTestObject('Page_CURA Healthcare Service/button_LoginS'))
